...
public class BookingServiceTest {
    ...
    @Test
    void getAllOwnersItemsTest() throws Exception {
        User owner = getUser(1);
        User booker = getUser(2);
        ...
        responseDtoList = bookingService.getAllOwnersItems(RequestStatus.ALL, owner.getId());
        ...
        verify(userService, times(6)).findUserOrNot(eq(owner.getId()));
        verify(bookingRepository, times(1)).findAllByItemOwnerIdOrderByStartDesc(eq(owner.getId()));
